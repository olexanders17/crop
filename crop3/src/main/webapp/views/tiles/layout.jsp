...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row" name="top">
			<div class="col-lg-12 col-md-12 col-sm-12  col-xs-12 " style="background-color: #white; border-color: #676A6C; color: #676a6c;">Header</div>
		</div>

		<div class="row" name="mid" style="background-color: #2f4050; color: #A7B1C2">
